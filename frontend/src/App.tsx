...
// Root API Endpoint derived from VITE_API_URL, fallback to location origin
...
const SOCIAL_NETWORKS_INFO = [
  ...
  { id: 'spotify', name: 'Spotify', desc: 'Protect artist and playlist creator profiles.', color: 'from-emerald-500/10 to-green-500/10 border-green-400/10 hover:border-green-405/30 text-green-400' },
            ...
            >
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-8 max-w-5xl mx-auto pt-6">
                ...
                <div className="bg-zinc-950/40 border border-zinc-900 rounded-2xl p-6 hover:border-blue-500/20 transition-all group flex flex-col justify-between">
                  ...
                  <button
                    onClick={() => navigateTo('username')}
                    className="w-full py-2.5 bg-zinc-900 hover:bg-zinc-800 text-zinc-300 hover:text-white font-medium rounded-xl text-xs transition-colors border border-zinc-850 flex items-center justify-center gap-1.5"
                  >
                      ...
                      >
                        ...
                        <div className="flex items-center gap-2">
                          {result.available === true ? (
                            ...
                            <span className="px-2.5 py-1 bg-red-950/20 text-red-400 text-[10px] font-bold border border-red-900/20 rounded-full flex items-center gap-1">
